...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // En caso de token inválido o expirado, no levantamos autenticación y dejamos que prosiga el filtro
            // para que Spring Security se encargue del rechazo en las rutas protegidas.
        }
