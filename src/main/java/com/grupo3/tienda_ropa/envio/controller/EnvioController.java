...
public class EnvioController {
    ...
    @PostMapping
    public ResponseEntity<EnvioResponse> crearEnvio(@Valid @RequestBody CrearEnvioRequest request) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EnvioResponse> obtenerEnvioPorId(@PathVariable Long id) {
        Envio envio = envioService.obtenerEnvioPorId(id);
        return ResponseEntity.ok(EnvioResponse.fromEntity(envio));
    }

    @GetMapping("/pedido/{pedidoId}")
    public ResponseEntity<EnvioResponse> obtenerEnvioPorPedidoId(@PathVariable Long pedidoId) {
    ...
    public ResponseEntity<String> consultarTracking(@PathVariable Long id) {
